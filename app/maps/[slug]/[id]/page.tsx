...
const mapPageStyles = `
  ...
  * {
  ...
  /* Header styles - adjusted to accommodate the actual header height */
  header {
    position: fixed;
    top: 0;
    left: 0;
    ...
    background: white;
    z-index: 50;
    min-height: 64px; /* Changed from fixed height to min-height */
  ...
  .map-container {
    ...
    padding-top: 64px; /* Added padding-top instead */
    left: 0;
    right: 0;
    bottom: 0;
    z-index: 10;
  ...
  /* Adjust for mobile header which might be taller */
  @media (max-width: 640px) {
    .map-container {
      padding-top: 90px; /* Increased padding for mobile */
    }
  }
